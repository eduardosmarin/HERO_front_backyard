...
# 3. Stress test about existing in Time 1, Time 2, and we need days in the ground; a lot of nested functions (walk through thats); we need to know from John when these trees were surveyed; the middle day of that that is June 30th [we need a sensitivity analysis] -- time is July 30th, so we assum that it is June 30th; do it again june 30ths; we need times and days between planted and inspected.
## 4. Double checked, in three do a Chi Square and Time in the ground is being ignored; saw it in time 1 and time 2; is it more different and it is a more descriptive, then we looking at the subset alive and dad. Then we build from there to a more sophisticated analysis with a binary outcomes. We need to understand the factors that differ between survivalship and how they fron tand bckyard

# Action Items
## 1. Request the Vintage 2017 from MassGIS | massgismail@mass.gov
####   https://www.mass.gov/info-details/massgis-data-property-tax-parcels (says I can vintage); just interested in assessed values and location ####. if they come back and say fields have changed

## 2. Switch IDs and check the one with John; one tree in there twice in Chelsea

## 3. We needs in the days in the ground; should see it
...
# 1. Investigate the diferent land use over the years and why they are changing
...
5. Email someone about 2017 Vintage Parcels; writing the data acquisition emails; some government employees is there will be instances where you ned that file to proceed; know that that data exists; poke around and email (3 minute or less and cc'd Dexter); also, includ you...good enough set of massgismail@gmail.com
