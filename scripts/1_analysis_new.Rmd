...
Final_Giveaway_Y2017_Y2024 <-
  st_read("input_data/Final_Giveaway_Y2017_Y2024_2025-11-12.gpkg") |>
  st_drop_geometry()
...
# ESM to DHL: Confidence intervals seem to be very large in the visualization here. What should we do?
...
# ESM to DHL: Seems that the significance levels being low is primarily due to the addition of the city variable
```

## b) Ecological
### i) Cross tabs

ESM to DHL: Should this be of Overall or Residential-specific? Second, is this based off of the variable looked at alone or in context with yard?
...
# ESM to DHL: Decided not to use this since there are way too many and it may be over-fitting. Also, the actual KM curve shows high instability due to these large, confidence intervals. Your chioce if we should use this but erring on the side of no
