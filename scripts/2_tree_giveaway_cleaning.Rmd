...
pre_hero_tree_giveaway <- 
  ...
  mutate(Row_ID = row_number()) |> # Need this since Unique_ID_New isn't really unique; also meeds to be before the pivot to maintain
  pivot_longer(
...
hero_tree_giveaway |>
  st_write(paste0("input_data/General/hero_tree_giveaway_", Sys.Date(), ".gpkg"))
