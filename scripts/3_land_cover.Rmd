...
Holyoke_Boundary_V2 <-
  ...
  st_union() |>
  st_transform(26986) # it would be better style, I (DHL) think, to put st_transform(st_crs(Holyoke_Boundary_V1)) instead. DONT make this change throughout, just something for your next project. If you need to change a projection, all other steps would match and auto-magically update.
...
Holyoke_V2_Area_M2 * 3.861e-7 # In square miles
