...
ggplot() +
  ...
  geom_sf(data =hero_tree_giveaway_dem |> filter(City == "HOLYOKE"), color = "darkgreen", size = 0.5) +
  scale_fill_viridis_c(option = "plasma") +
  theme_minimal() +
  labs(title = "HERO Tree Giveaway Points over Median Household Income") #Not that useful
...
summarize_region <- 
  ...
  data |>
    ...
    ,  pct_at_least_hs = mean(pct_at_least_hs, na.rm = TRUE)
    ,  pct_at_least_college = mean(pct_at_least_college, na.rm = TRUE)
